...
using Turnero.Infrastructure.Data;
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Allergies", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.CongErrors", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.ContactInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.GrowthChart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Medic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.ParentsData", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.PerinatalBackground", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.PermMed", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.PersonalBackground", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.TimeTurn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Turn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Vaccines", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Visit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Allergies", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Patient", "Patient")
                        .WithMany("Allergies")
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.CongErrors", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Patient", "Patient")
                        .WithOne("CongErrors")
                        .HasForeignKey("Turnero.Domain.Entities.CongErrors", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.ContactInfo", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Patient", "Patient")
                        .WithOne("ContactInfo")
                        .HasForeignKey("Turnero.Domain.Entities.ContactInfo", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.ParentsData", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Patient", "Patient")
                        .WithOne("Parent")
                        .HasForeignKey("Turnero.Domain.Entities.ParentsData", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.PerinatalBackground", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Patient", "Patient")
                        ...
                        .HasForeignKey("Turnero.Domain.Entities.PerinatalBackground", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.PersonalBackground", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Patient", "Patient")
                        ...
                        .HasForeignKey("Turnero.Domain.Entities.PersonalBackground", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnero.Domain.Entities.Turn", b =>
                {
                    b.HasOne("Turnero.Domain.Entities.Medic", "Medic")
                        .WithMany("Turns")
                        .HasForeignKey("MedicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Turnero.Domain.Entities.Patient", null)
                        .WithMany("Turns")
                        .HasForeignKey("PatientId");

                    b.HasOne("Turnero.Domain.Entities.TimeTurn", "Time")
                        .WithMany("Turns")
