namespace Turnero.Application.Services.TurnsServices;

public class GetTurnDTOServices(ITurnDTORepository turnRepository, IOptions<DatabaseOptions> databaseOptions) : IGetTurnDTOServices
{
    private readonly string _connectionString = databaseOptions.Value.PostgresConnection
        ?? throw new InvalidOperationException("ConnectionString no puede ser nulo.");
