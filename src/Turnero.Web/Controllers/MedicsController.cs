...
public class MedicsController(UserManager<IdentityUser> userManager,
                        ...
                        IAntiforgery antiforgery) : TurneroBaseController(getMedicsServices, getTimeTurns, antiforgery)
{
    // Nota: getMedicsServices se captura acá y en la base; la base lo expone como GetMedics.
    private IGetMedicsServices GetMedicsServices { get; } = getMedicsServices;
