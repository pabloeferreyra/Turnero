...
namespace Turnero.Migrations
{
    ...
    [Migration("20251129005524_Vaccinesv2")]
    partial class Vaccinesv2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Turnero.DAL.Models.Vaccines", b =>
                {
                    ...
                    b.Property<DateOnly>("Bcg")
                        .HasColumnType("date");

                    b.Property<string>("Description")
                        .HasColumnType("text");

                    b.Property<DateOnly>("Dpt")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Dta")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Flu")
                        .HasColumnType("date");

                    b.Property<DateOnly>("HepA")
                        .HasColumnType("date");

                    b.Property<DateOnly>("HepB")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Hib")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Meningo")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Other")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Pneumo")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Pox")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Prs")
                        .HasColumnType("date");

                    b.Property<DateOnly>("Sabin")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Turnero.DAL.Models.Patient", b =>
                {
                    ...
                    b.HasOne("Turnero.DAL.Models.Vaccines", "Vaccines")
                        .WithMany()
