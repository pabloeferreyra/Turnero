    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeTurnViewModel", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTurn = table.Column<DateTime>(nullable: false, defaultValueSql: "getdate()"),
                    TimeId = table.Column<Guid>(nullable: true),
                    Accessed = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
